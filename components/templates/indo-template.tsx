    ...
    <section className="flex bg-white rounded overflow-auto template h-full drop-shadow-[0_8px_20px_rgba(0,0,0,0.08)] transition ease-in-out hover:outline hover:outline-cyan-500 duration-300 hover:shadow-2xl hover:shadow-slate-500/10">
      ...
      <div className="p-4 space-y-4 w-full" role="button">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="font-bold text-[9px]">Frontend developer</p>
        ...
        {/**objective summary */}
        <div>
          <h2 className=" font-extrabold leading-none uppercase text-[9px] w-[145px] text-white bg-slate-500 py-1 px-2">
        ...
        <article>
          <div>
            <header className="mt-4">
              <h2 className="uppercase text-[9px] leading-none font-extrabold w-[78px] text-white bg-slate-500 py-1 px-2">
                EXPERIENCE
              </h2>
        ...
        <article>
          <div>
            <header className="mt-4">
              <h2 className="text-[9px] font-extrabold  w-[73px] text-white bg-slate-500 py-1 px-2">
                EDUCATION
              </h2>
              <hr className="border-[0.5px] border-slate-500 mb-2" />
              <div className="mt-4 mb-2">
        ...
        <article className="space-y-2">
          <div className="space-y-2">
            <header>
              <h2 className="text-[9px] font-extrabold w-[68px] text-white bg-slate-500 py-1 px-2">
                PROJECTS
              </h2>
              <hr className="border-[0.5px] border-slate-500 mb-2" />
              <p className="text-[11px]">
